...
{% hint style="success" %}
You'll get a notification when the build completes — by email, Slack, or whatever you configured under [Broken link](/broken/pages/d9d593aeabc52a165190bf8c93720491a4eb9682 "mention").
{% endhint %}
